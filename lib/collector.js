...
(function() {
  ...
  Collector = (function() {
    ...
    Collector.prototype.track = function() {
      var args, _ref;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (_ref = this.counters).track.apply(_ref, args);
    };
    ...
    Collector.prototype.flushToWithSource = function(queue) {
      return this.counters.flushToWithSource(queue);
    };
